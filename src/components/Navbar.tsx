    ...
    >
      <div className="flex items-center justify-center h-16">
        <div className="hidden lg:flex items-center gap-6">
          ...
          <div className="flex items-center gap-3 ml-4">
            <Link
              to="/unete"
              className="text-sm font-semibold bg-foreground text-background px-4 py-1.5 rounded-full hover:bg-foreground/90 transition-colors"
            >
              Únete al movimiento
            </Link>
      ...
      {mobileOpen && (
        ...
        >
          ...
          <Link to="/unete" onClick={() => setMobileOpen(false)} className="mx-3 mt-2 text-sm font-semibold bg-foreground text-background px-4 py-2 rounded-full text-center">Únete al movimiento</Link>
        </motion.div>
      )}
    </motion.nav>
  );
